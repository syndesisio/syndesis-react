...
export default class ExtensionImportPage extends React.Component<{}, IExtensionImportPageState> {
            ...
            <AppContext.Consumer>
                {({ pushNotification }) => {
                    const onDndUploadRejectedHandler = (failedFileName: string) => {
                        const text = i18n.t('customizations:extension.importUploadFailedAlertMessage', {
                                    ...
                                    {({ importExtension, uploadExtension }) => {
                                        const onDndUploadAcceptedHandler = async (files: File[]) => {
                                            try {
                                                ...
                                                pushNotification(`${uploaded.id} was uploaded`, 'success');
                                                    ...
                                                    <>
                                                        ...
                                                        this.state.extension.extensionId ? (
                                                            <ExtensionImportReview
                                                                ...
                                                                extensionDescription={this.state.extension.description}
