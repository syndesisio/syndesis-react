...
var ApiContext = createContext(ApiContextDefaultValue);
...
var SyndesisFetch = /*@__PURE__*/(function (superclass) {
  ...
  SyndesisFetch.prototype.render = function render () {
    ...
    return createElement(ApiContext.Consumer, null, function (ref) {
      var apiUri = ref.apiUri;
      var headers = ref.headers;

      return createElement(FetchOrStream, Object.assign({
      baseUrl: apiUri,
      url: url,
      headers: headers
    }, props));
...
var DVFetch = /*@__PURE__*/(function (superclass) {
  ...
  DVFetch.prototype.render = function render () {
    ...
    return createElement(ApiContext.Consumer, null, function (ref) {
      ...
      return createElement(Fetch, Object.assign({
      baseUrl: dvApiUri,
      url: url,
      headers: {}
    }, props));
...
var ServerEventsContext = createContext(ServerEventsContextDefaultValue);
...
var WithIntegrationHelpers = function (props) { return createElement(ApiContext.Consumer, null, function (apiContext) { return createElement(WithIntegrationHelpersWrapped, Object.assign({}, props, apiContext)); }); };
...
var WithApiConnectors = /*@__PURE__*/(function (superclass) {
  ...
  WithApiConnectors.prototype.render = function render () {
    ...
    return createElement(SyndesisFetch, {
...
var WithExtensionHelpers = function (props) { return createElement(ApiContext.Consumer, null, function (apiContext) { return createElement(WithExtensionHelpersWrapped, Object.assign({}, props, apiContext)); }); };
...
var WithExtensionIntegrations = /*@__PURE__*/(function (superclass) {
  ...
  WithExtensionIntegrations.prototype.render = function render () {
    ...
    return createElement(SyndesisFetch, {
      ...
      return this$1.props.disableUpdates ? this$1.props.children(response) : createElement(ServerEventsContext.Consumer, null, function (ref) {
      var registerChangeListener = ref.registerChangeListener;
      var unregisterChangeListener = ref.unregisterChangeListener;
...
var WithMonitoredIntegrations = /*@__PURE__*/(function (superclass) {
  ...
  WithMonitoredIntegrations.prototype.render = function render () {
    ...
    return createElement(WithIntegrations, {
...
var WithIntegrationsMetrics = /*@__PURE__*/(function (superclass) {
  ...
  WithIntegrationsMetrics.prototype.render = function render () {
    ...
    return createElement(SyndesisFetch, {
      ...
      return createElement(WithPolling, {
        read: read,
        polling: 5000
      }, function () { return this$1.props.children(response); });
    });
...
var WithVirtualizationHelpers = function (props) { return createElement(ApiContext.Consumer, null, function (apiContext) { return createElement(WithVirtualizationHelpersWrapped, Object.assign({}, props, apiContext)); }); };
...
export { ApiContextDefaultValue, ApiContext, SyndesisFetch, callFetch, DVFetch, Fetch, ServerEventsContextDefaultValue, ServerEventsContext, Stream, NEW_INTEGRATION, WithIntegrationHelpersWrapped, WithIntegrationHelpers, WithApiConnectors, WithExtension, WithExtensionHelpersWrapped, WithExtensionHelpers, WithExtensionIntegrations, WithExtensions, WithIntegrations, WithMonitoredIntegrations, WithIntegrationsMetrics, getConnectionsForDisplay, getConnectionsWithFromAction, getConnectionsWithToAction, transformResponse, WithConnections, WithConnection, WithConnectors, WithPolling, WithChangeListener, WithServerEvents, getActionsWithFrom, getActionsWithTo, getConnectionConnector, getConnectorActions, getActionById, getActionDescriptor, getActionSteps, getActionStep, getActionStepDefinition, serializeIntegration, deserializeIntegration, WithViews, WithVirtualizationHelpersWrapped, WithVirtualizationHelpers, WithVirtualization, WithVirtualizations };
