...
import { ControlLabel, FormControl, FormGroup, HelpBlock, Checkbox } from 'patternfly-react';
...
var FormInputComponent = function (props) { return createElement(FormGroup, {
  controlId: props.field.name,
  validationState: getValidationState(props)
}, createElement(ControlLabel, null, props.property.displayName), createElement(FormControl, Object.assign({}, props.field, {
  "data-testid": props.field.name,
  disabled: props.form.isSubmitting || props.property.disabled,
  placeholder: props.property.placeholder,
  type: props.type || 'text',
  onChange: props.field.onChange
})), createElement(HelpBlock, null, props.property.description, props.form.errors[props.field.name])); };

var FormSelectComponent = function (props) { return createElement(FormGroup, {
  controlId: props.field.name,
  validationState: getValidationState(props)
}, createElement(ControlLabel, null, props.property.displayName), createElement(FormControl, Object.assign({}, props.field, {
  "data-testid": props.field.name,
...
}), props.property.enum && props.property.enum.map(function (opt) { return createElement("option", {
  key: opt.value,
  value: opt.value
}, opt.label); })), createElement(HelpBlock, null, props.property.description, props.form.errors[props.field.name])); };

var FormTextAreaComponent = function (props) { return createElement(FormGroup, {
  controlId: props.field.name,
  validationState: getValidationState(props)
}, createElement(ControlLabel, null, props.property.displayName), createElement(FormControl, Object.assign({}, props.field, {
  "data-testid": props.field.name,
...
var FormCheckboxComponent = function (props) { return createElement(FormGroup, {
  controlId: props.field.name,
  validationState: getValidationState(props)
}, createElement(Checkbox, Object.assign({}, props.field, {
  id: props.field.name,
  checked: props.field.value,
  "data-testid": props.field.name,
  disabled: props.form.isSubmitting || props.property.disabled
}), props.property.displayName), createElement(HelpBlock, null, props.property.description, props.form.errors[props.field.name])); };

var FormHiddenComponent = function (props) { return createElement("div", null, createElement("input", Object.assign({
  type: props.type,
  id: props.name,
  "data-testid": props.name
}, props.field)), props.form.touched[props.field.name] && props.form.errors[props.field.name] && createElement("div", {
  className: "error"
...
var FormBuilder = /*@__PURE__*/(function (superclass) {
  function FormBuilder() {
    ...
    this.getField = function (props) {
      ...
      return createElement(Field, Object.assign({
...
var AutoForm = /*@__PURE__*/(function (superclass) {
  ...
  AutoForm.prototype.render = function render () {
    ...
    return createElement(Fragment, null, createElement(FormBuilder, {
      ...
      errors: errors,
      fields: createElement(Fragment, null, fields.map(function (property) { return getField({
        errors: errors,
        property: property,
        touched: touched,
