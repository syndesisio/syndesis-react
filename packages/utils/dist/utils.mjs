...
function makeResolverNoParams(route) {
  return function () { return reverse(route); };
}
...
var WithRouteData = /*@__PURE__*/(function (superclass) {
  ...
  WithRouteData.prototype.render = function render () {
    ...
    return createElement(Route, null, function (route) {
      if (!route.match) {
...
var WithRouter = withRouter(WithRouterBase);

export { getConnectionIcon, key, makeResolver, makeResolverNoParams, WithListViewToolbarHelpers, createOptionalInt, optionalIntValue, optionalIntHasValue, WithLoader, WithRouteData, WithRouterBase, WithRouter };
