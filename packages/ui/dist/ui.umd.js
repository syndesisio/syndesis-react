(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react-router'), require('react-dropzone'), require('react-virtualized'), require('classnames'), require('react-router-dom'), require('patternfly-react'), require('react'), require('react-content-loader')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react-router', 'react-dropzone', 'react-virtualized', 'classnames', 'react-router-dom', 'patternfly-react', 'react', 'react-content-loader'], factory) :
  (factory((global.ui = {}),global.reactRouter,global.Dropzone,global.reactVirtualized,global.classnames,global.reactRouterDom,global.patternflyReact,global.react,global.ContentLoader));
}(this, (function (exports,reactRouter,Dropzone,reactVirtualized,classnames,reactRouterDom,patternflyReact,React,ContentLoader) {
